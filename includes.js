(function () {
  ...
  var navCSS = [
    ...
    '.nav-logo-img{height:42px;width:auto;object-fit:contain;display:block;border:none;outline:none;box-shadow:none;}',
    '.nav-logo a{border:none;outline:none;text-decoration:none;}',
